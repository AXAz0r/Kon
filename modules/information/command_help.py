...
async def ex(args, message, bot, invoke):
    if args:
        ...
        if module == 'banking':
            ...
            "- id - Returns the ID of the mentioned object. If no object is mentioned, it returns the authors ID.\n"
            ...
            "added after the role name if desired by separating the role name from the post with :: and a space\n"
